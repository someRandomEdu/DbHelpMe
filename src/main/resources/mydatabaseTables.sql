...
-- Insert books
INSERT INTO books (title, publisher, description, quantity) VALUES
                                                                ('To Kill a Mockingbird', 'J.B. Lippincott & Co.', 'A novel about racial injustice.', 2),
                                                                ('1984', 'Secker & Warburg', 'A dystopian novel about totalitarianism.', 2),
                                                                ('Pride and Prejudice', 'T. Egerton', 'A romantic novel of manners.', 1),
                                                                ('The Great Gatsby', 'Charles Scribner\'s Sons', 'A novel about the American dream.', 1),
('Moby Dick', 'Harper & Brothers', 'A novel about a giant white whale.', 1),
('War and Peace', 'The Russian Messenger', 'A novel about Napoleon\'s invasion of Russia.', 2),
                                                                ('The Catcher in the Rye', 'Little, Brown and Company', 'A story about teenage rebellion.', 2),
                                                                ('The Hobbit', 'George Allen & Unwin', 'A fantasy novel about a hobbit\'s adventure.', 2),
('The Alchemist', 'HarperOne', 'A novel about following one\'s dreams.', 3),
                                                                ('The Book Thief', 'Picador', 'A story set in Nazi Germany.', 3);
...
ADD COLUMN read_link VARCHAR(255) DEFAULT NULL;
